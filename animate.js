...
export function background3d(t, backgroundConfig) {
  let ctx = {
  ...
  ctx.init = () => {
    return new Promise(async (resolve, reject) => {
      ...
      if (typeof backgroundConfig === `string`) {
        ...
        ctx.objectTree = backgroundConfig;
      }
      ...
      // const threemfLoader = new ThreeMFLoader( manager );
      // manager.onLoad = function () {
      //   ctx.renderer.render();
      // };
      const threemfLoader = new ThreeMFLoader();
      function load3mfAlt( url ) {
        return new Promise((resolve, reject) => {
          threemfLoader.load(url, resolve, () => {}, reject);
        })
      }
        ...
        for (let i in o) {
          ...
          switch (object.type) {
            ...
            case 'object':
              ...
              console.log(`object.element (obj):`, object.element)
            ...
            case '3mf':
              ...
              object.material.material = generateMaterial(object.material);
              object.element = await load3mf(object.url);
              console.log(`object.element (3mf):`, object.element)
              object.element.children.forEach(child => {
                child.material = object.material.material;
                child.castShadow = object.castShadow;
                child.receiveShadow = object.receiveShadow;
              });
              break;
            case 'extruded2d':
              object.material.material = generateMaterial(object.material);
